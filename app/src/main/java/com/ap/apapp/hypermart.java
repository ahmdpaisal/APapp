    ...
    private void tampilkanpilihan(String pilihan) {
        try{
            ...
            if (pilihan.equals("Call Center")){
                ...
                a.setData(Uri.parse("sms:081276186410"));
                a.putExtra("sms_body", smstxt);
            }
            else if(pilihan.equals("Driving Direction")){
                String lokasirs = "google.navigation:q=0.5004451270323064, 101.418225";
                ...
                a.putExtra(SearchManager.QUERY, "Hypermart Pekanbaru");
            }
